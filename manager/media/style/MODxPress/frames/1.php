...
<head>
	<script type="text/javascript">
		window.globalVars = {
			"somevar": "someval",
			"unable_set_parent": '<?php echo addslashes($_lang['unable_set_parent']); ?>',
			...
			"toggleNodeLoadText": "<?php echo addslashes($_lang['loading_doc_tree']);?>",
			...
			"emptyTrash": "<?php echo addslashes($_lang['confirm_empty_trash']); ?>",
			"treeActionAlert": '<?php echo addslashes($_lang["unable_set_parent"]); ?>',
			"treeActionHref": "<?php echo (!empty($modx->config['tree_page_click']) ? $modx->config['tree_page_click'] : '27'); ?>",
			"treeActionAlertParent": '<?php echo addslashes($_lang["unable_set_parent"]); ?>',
			"treeActionAlertLink": '<?php echo addslashes($_lang["unable_set_link"]); ?>',
			"showBinFullTitle": '<?php echo addslashes($_lang["empty_recycle_bin"]); ?>',
			"showBinFullInnerHtml": '<?php echo $_style["empty_recycle_bin"]; ?>',
			"showBinEmptyTitle": '<?php echo addslashes($_lang["empty_recycle_bin_empty"]); ?>',
			"showBinEmptyInnerHtml": '<?php echo $_style["empty_recycle_bin_empty"]; ?>',
			"removeLock": "<?php echo addslashes($_lang['confirm_remove_locks']); ?>",
			"menuHandler_case_4": "<?php echo addslashes($_lang['confirm_delete_resource']); ?>",
			"menuHandler_case_4_else": "<?php echo addslashes($_lang['already_deleted']); ?>",
			"menuHandler_case_7": "<?php echo addslashes($_lang['confirm_resource_duplicate']); ?>",
			"menuHandler_case_8": "<?php echo addslashes($_lang['not_deleted']); ?>",
			"menuHandler_case_8_else": "<?php echo addslashes($_lang['confirm_undelete']); ?>",
			"menuHandler_case_9": "<?php echo addslashes($_lang['confirm_publish']); ?>",
			"menuHandler_case_10": "<?php echo addslashes($_lang['confirm_unpublish']); ?>",
