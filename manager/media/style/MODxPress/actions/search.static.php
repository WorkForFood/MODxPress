...
<div id="actions">
  <ul class="actionButtons">
    <li id="Button5"><a href="#" onclick="documentDirty=false;document.location.href='index.php?a=2';"><span class="<?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel']?></a></li>
  </ul>
</div>
  ...
  <div class="sectionBody">
    <form action="index.php?a=71" method="post" name="searchform" enctype="multipart/form-data">
      ...
      <tr>
        <td colspan="4">
          <ul class="actionButtons">
            <li><a class="default" href="#" onclick="document.searchform.submitok.click();"><span class="<?php echo $_style["icons_save"] ?>"></span> <?php echo $_lang['search'] ?></a></li>
            <li><a href="index.php?a=2"><span class="<?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel'] ?></a></li>
          </ul>
        </td>
      </tr>
    </table>
 ...
 <div class="section">
  ...
  if($limit<1) {
    ...
    // figure out the icon for the document...
        ...
        ?>
        <tr>
          <td align="center"><a href="index.php?a=3&id=<?php echo $row['id']; ?>" title="<?php echo $_lang['search_view_docdata']; ?>"><span class="fileactions <?php echo $_style['icons_resource_overview']; ?>"></span></a></td>
          ...
          ?>
          <td align="center"><span class="fileactions <?php echo $icon; ?>"></span></td>
        </tr>
        <?php
      }
      ?>
