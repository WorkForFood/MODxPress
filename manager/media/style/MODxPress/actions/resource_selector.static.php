...
<p><span class="<?php echo $_style["icons_right_arrow"] ?>" alt="." width="32" height="32" align="left"></span> <?php echo $_lang['element_selector_msg']; ?></p>
<br />
<!-- resources -->
	...
	<div class="searchbar">
		<table border="0" width="100%">
			...
			<td nowrap="nowrap">
				...
				<td><a href="#" class="searchbutton" title="<?php echo $_lang["reset"];?>" onclick="resetSearch();return false;"><span class="<?php echo $_style['icons_refresh']?>" width="16" height="16"></span></a></td>
				<td><a href="#" class="searchbutton" title="<?php echo $_lang["list_mode"];?>" onclick="changeListMode();return false;"><span class="<?php echo $_style['icons_table']?>" width="16" height="16"></span></a></td>
				</tr>
				</table>
			</td>
			<td width="200">
				<a href="#" class="searchtoolbarbtn" style="float:right;margin-left:2px;" onclick="window.close()"><span class="<?php echo $_style['icons_cancel']?>"></span> <?php echo $_lang['cancel']; ?></a>
				<a href="#" class="searchtoolbarbtn" style="float:right;margin-left:2px;" onclick="saveSelection()"><span class="<?php echo $_style['icons_add']?>"></span> <?php echo $_lang['insert']; ?></a>				
			</td>
			</tr>
		</table>
	</div>	
