...
<script type="text/javascript" src="media/script/tablesort.js"></script>
	...
	<div id="actions">	
	  <ul class="actionButtons">
		  <li id="Button1">
			<a href="#" onclick="editdocument();"><span class="<?php echo $_style["icons_edit_document"] ?>"></span> <?php echo $_lang['edit']?></a>
		  </li>
		  <li id="Button2">
			<a href="#" onclick="movedocument();"><span class="<?php echo $_style["icons_move_document"] ?>"></span> <?php echo $_lang['move']?></a>
		  </li>
		  <li id="Button4">
		    <a href="#" onclick="duplicatedocument();"><span class="<?php echo $_style["icons_resource_duplicate"] ?>"></span> <?php echo $_lang['duplicate']?></a>
		  </li>
		  <li id="Button3">
		    <a href="#" onclick="deletedocument();"><span class="<?php echo $_style["icons_delete_document"] ?>"></span> <?php echo $_lang['delete']?></a>
		  </li>
		  <li id="Button6">
			<a href="#" onclick="<?php echo ($modx->config['friendly_urls'] == '1') ? "window.open('".$modx->makeUrl($id)."','previeWin')" : "window.open('".$modx->config['site_url']."index.php?id=$id','previeWin')"; ?>"><span class="<?php echo $_style["icons_preview_resource"]?>"></span> <?php echo $_lang['preview']?></a>
		  </li>
	  </ul>
	</div>
...
<?php if ($modx->hasPermission('new_document')) { ?>
			...
			<ul class="actionButtons">
				<li><a href="index.php?a=4&amp;pid=<?php echo $content['id']?>"><span class="<?php echo $_style["icons_new_document"]; ?>" align="absmiddle" ></span> <?php echo $_lang['create_resource_here']?></a></li>
				<li><a href="index.php?a=72&amp;pid=<?php echo $content['id']?>"><span class="<?php echo $_style["icons_new_weblink"]; ?>" align="absmiddle" ></span> <?php echo $_lang['create_weblink_here']?></a></li>
			</ul>
<?php }
	if ($numRecords > 0)
