...
<table width="600" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <ul class="actionButtons">
        <li id="btn_reply"><a href="index.php?a=10&t=c&m=rp&id=<?php echo $message['id']; ?>"><span class="<?php echo $_style["icons_message_reply"] ?>"></span> <?php echo $_lang['messages_reply']; ?></a></li>
        <li><a href="index.php?a=10&t=c&m=f&id=<?php echo $message['id']; ?>"><span class="<?php echo $_style["icons_message_forward"] ?>"></span> <?php echo $_lang['messages_forward']; ?></a></li>
        <li><a href="index.php?a=65&id=<?php echo $message['id']; ?>"><span class="<?php echo $_style["icons_delete_document"] ?>"></span> <?php echo $_lang['delete']; ?></a></li>
...
<ul class="actionButtons">
        <li><a href="#" onclick="documentDirty=false; document.messagefrm.submit();"><span class="<?php echo $_style["icons_save"] ?>"></span> <?php echo $_lang['messages_send']; ?></a></li>
        <li><a href="index.php?a=10&t=c"><span class="<?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel']; ?></a></li>
</ul>
