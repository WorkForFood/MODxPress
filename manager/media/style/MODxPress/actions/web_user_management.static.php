...
<div class="sectionBody">
	...
	<div class="searchbar">
		<table border="0" style="width:100%" class="actionButtons">
			<tr>
			<td><a href="index.php?a=87"><span class="<?php echo $_style["icons_save"] ?>"></span> <?php echo $_lang['new_web_user']; ?></a></td>
			<td nowrap="nowrap">
	...
	$grd->colTypes="template:<a class='gridRowIcon' href='#' onclick='return showContentMenu([+id+],event);' title='".$_lang["click_to_context"]."'><span class='".$_style["icons_user"]."'></span></a>||template:<a href='index.php?a=88&id=[+id+]' title='".$_lang["click_to_edit_title"]."'>[+value+]</a>";
