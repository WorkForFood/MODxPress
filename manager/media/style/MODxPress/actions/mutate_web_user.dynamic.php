...
<div id="actions">
	<ul class="actionButtons">
			<li><a href="#" onclick="documentDirty=false; document.userform.save.click();"><span class="<?php echo $_style["icons_save"] ?>"></span> <?php echo $_lang['save']; ?></a><span class="plus"> + </span>
			...
			<li id="btn_del"><a href="#" onclick="deleteuser();"><span class="<?php echo $_style["icons_delete"] ?>"></span> <?php echo $_lang['delete']; ?></a></li>
<?php if($_GET['a']!='88') { ?>
			<script type="text/javascript">document.getElementById("btn_del").className='disabled';</script>
<?php } ?>
			<li><a href="#" onclick="documentDirty=false;document.location.href='index.php?a=99';"><span class="<?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel']; ?></a></li>
	</ul>
</div>
		...
		<tr>
		  ...
		  <tr>
			...
			<td>
				...
				<a onclick="document.userform.dob.value=''; return true;" onmouseover="window.status='<?php echo $_lang['remove_date']; ?>'; return true;" onmouseout="window.status=''; return true;" style="cursor:pointer; cursor:hand"><span align="absmiddle" class="<?php echo $_style["icons_cal_nodate"]?>" border="0" alt="<?php echo $_lang['remove_date']; ?>"></span></a>
			</td>
		  </tr>
		  <tr>
		...
		<?php if($_GET['a']=='88') { ?>
		  ...
		  <tr>
			...
			<td>
				...
				<a onclick="document.userform.blockeduntil.value=''; return true;" onmouseover="window.status='<?php echo $_lang['remove_date']; ?>'; return true;" onmouseout="window.status=''; return true;" style="cursor:pointer; cursor:hand"><span align="absmiddle" class="<?php echo $_style["icons_cal_nodate"]?>" border="0" alt="<?php echo $_lang['remove_date']; ?>"></span></a>
			</td>
		  </tr>
		  <tr>
			...
			<td>
				...
				<a onclick="document.userform.blockedafter.value=''; return true;" onmouseover="window.status='<?php echo $_lang['remove_date']; ?>'; return true;" onmouseout="window.status=''; return true;" style="cursor:pointer; cursor:hand"><span align="absmiddle" class="<?php echo $_style["icons_cal_nodate"]?>" border="0" alt="<?php echo $_lang['remove_date']; ?>"></span></a>
			</td>
		  </tr>
		<?php
		}
