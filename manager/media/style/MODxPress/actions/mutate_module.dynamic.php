...
<input type="hidden" name="mode" value="<?php echo $_GET['a']?>">
    ...
    <div id="actions">
          <ul class="actionButtons">
              ...
              <?php
                if ($_REQUEST['a'] == '108') { ?>
              <li id="Button2" class="disabled"><a href="#" onclick="deletedocument();"><span class="<?php echo $_style["icons_delete_document"]?>"></span> <?php echo $_lang['delete']?></a></li>
              <?php } else { ?>
              <li id="Button2"><a href="#" onclick="deletedocument();"><span class="<?php echo $_style["icons_delete_document"]?>"></span> <?php echo $_lang['delete']?></a></li>
              <?php } ?>
              <li id="Button5"><a href="#" onclick="documentDirty=false;document.location.href='index.php?a=106';"><span class="<?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel']?></a></li>
              <?php // In Place for future extraction of actionbar
                    if ($_REQUEST['a'] == '27') { ?>
                        <li id="Button6"><a href="#" onclick="window.open('<?php echo $modx->makeUrl($id); ?>','previeWin');"><span class="<?php echo $_style["icons_preview"]?>"></span> <?php echo $_lang['preview']?></a></li>
              <?php } ?>
          </ul>
    </div>
    <!-- end #actions -->

<div class="sectionBody"><p><span class="icon <?php echo $_style["icons_modules_large"]?>" alt="." width="32" height="32" style="vertical-align:middle;text-align:left;"></span> <?php echo $_lang['module_msg']?></p>
...
<?php if ($_REQUEST['a'] == '108'): ?>
    ...
    <div class='actionButtons'>
        <a class="searchtoolbarbtn" href="#" onclick="loadDependencies();return false;"><span class="<?php echo $_style["icons_save"]?>" align="absmiddle"></span> <?php echo $_lang['manage_depends']?></a><br /><br /></p></td></tr>
    </div>
