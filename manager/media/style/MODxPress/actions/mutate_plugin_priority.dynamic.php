...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="media/style/'.$modx->config['manager_theme'].'/styles/icoMoon.css" />
    <link rel="stylesheet" type="text/css" href="media/style/'.$modx->config['manager_theme'].'/styles/fontAwesome.css" />
    <link rel="stylesheet" type="text/css" href="media/style/'.$modx->config['manager_theme'].'/styles/fonts.css" />
...
<div id="actions"
   <ul class="actionButtons">
       	<li><a href="#" onclick="save();"><span class="'.$_style["icons_save"].'"></span> '.$_lang['save'].'</a></li>
		<li><a href="#" onclick="document.location.href=\'index.php?a=76\';"><span class="'.$_style["icons_cancel"].'"></span> '.$_lang['cancel'].'</a></li>
	</ul>
</div>
