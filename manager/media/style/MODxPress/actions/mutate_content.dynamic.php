...
function enableParentSelection(b) {
    ...
    var element = document.getElementById("plock");
...
<div id="actions" class="">
      <ul class="actionButtons">
          <li id="Button1">
            <?php
                $dropdownActivatorInsert = $_REQUEST['stay']=='1' ? $_lang['stay_new'] : ( $_REQUEST['stay']=='2' ? $_lang['stay'] : $_lang['close']);
            ?>
            <a href="#" class="dropdownButton primary" onclick="documentDirty=false; document.mutate.save.click();">
              <span class="dropdownActivator"><span class="nomobile"><span class="<?php echo $_style["icons_save"]?>"></span> <?php echo $_lang['save']?></span><span class="ismobile none <?php echo $_style["icons_save"]?>"></span> + <span class="dropdownActivatorInsert"><?php echo $dropdownActivatorInsert; ?></span></span>
              <div class="dropdownList">
                <div class="dropdownListItem"> + <span class="dropdownListItemText"><?php echo $_lang['stay_new']?></span>
                  <input type="radio" name="stay" value="1" <?php echo $_REQUEST['stay']=='1' ? ' checked="checked"' : ''?>>
                </div>
                <div class="dropdownListItem"> + <span class="dropdownListItemText"><?php echo $_lang['stay']?></span>
                  <input type="radio" name="stay" value="2" <?php echo $_REQUEST['stay']=='2' ? ' checked="checked"' : ''?>>
                </div>
                <div class="dropdownListItem"> + <span class="dropdownListItemText"><?php echo $_lang['close']?></span>
                  <input type="radio" name="stay" value="" <?php echo $_REQUEST['stay']=='' ? ' checked="checked"' : ''?>>
                </div>
              </div>
            </a>
          <!--
            <a href="#" class="primary" onclick="documentDirty=false; document.mutate.save.click();">
              <span class="<?php echo $_style["icons_save"]?>"></span> <?php echo $_lang['save']?>
          ...
          <li id="Button2" class="disabled"><a href="#" onclick="deletedocument();"><span class="buttonIcon <?php echo $_style["icons_delete_document"] ?>"></span> <?php echo $_lang['delete']?></a></li>
          <?php } else { ?>
          <li id="Button6"><a href="#" onclick="duplicatedocument();"><span class="nomobile"><span class="buttonIcon <?php echo $_style["icons_resource_duplicate"] ?>"></span> <?php echo $_lang['duplicate']?></span><span class="buttonIcon <?php echo $_style["icons_resource_duplicate"] ?> ismobile none"></span></a></li>
          <li id="Button3"><a href="#" onclick="deletedocument();"><span class="nomobile"><span class="buttonIcon <?php echo $_style["icons_delete_document"] ?>"></span> <?php echo $_lang['delete']?></span><span class="buttonIcon <?php echo $_style["icons_delete_document"] ?> ismobile none"></span></a></li>
          <?php } ?>
          <li id="Button4"><a href="#" onclick="documentDirty=false;<?php echo $id==0 ? "document.location.href='index.php?a=2';" : "document.location.href='index.php?a=3&amp;id=$id".htmlspecialchars($add_path)."';"?>"><span class="nomobile"><span class="buttonIcon <?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel']?></span><span class="buttonIcon ismobile none <?php echo $_style["icons_cancel"] ?>"></span></a></li>
          <li id="Button5"><a href="#" onclick="window.open('<?php echo $modx->makeUrl($id); ?>','previeWin');"><span class="nomobile"><span class="buttonIcon <?php echo $_style["icons_preview_resource"] ?>"></span> <?php echo $_lang['preview']?></span><span class="buttonIcon ismobile none <?php echo $_style["icons_preview_resource"] ?>"></a></li>
      </ul>
</div>
    ...
    <div class="tab-page" id="tabGeneral">
        ...
        <table width="99%" border="0" cellspacing="5" cellpadding="0">
            <tr style="height: 24px;"><td width="100" align="left"><span class="warning"><?php echo $_lang['resource_title']?></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_title_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
            <tr style="height: 24px;"><td align="left"><span class="warning"><?php echo $_lang['long_title']?></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_long_title_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
            <tr style="height: 24px;"><td><span class="warning"><?php echo $_lang['resource_description']?></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_description_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
            <tr style="height: 24px;"><td><span class="warning"><?php echo $_lang['resource_alias']?></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_alias_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
            <tr style="height: 24px;"><td><span class="warning"><?php echo $_lang['link_attributes']?></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['link_attributes_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>

<?php if ($content['type'] == 'reference' || $_REQUEST['a'] == '72') { // Web Link specific ?>

            <tr style="height: 24px;"><td><span class="warning"><?php echo $_lang['weblink']?></span> <span name="llock" class="<?php echo $_style["tree_folder"] ?>" alt="tree_folder" onclick="enableLinkSelection(!allowLinkSelection);" style="cursor:pointer;"></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_weblink_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
...
<?php } ?>
            ...
            <tr style="height: 24px;"><td valign="top" width="100" align="left"><span class="warning"><?php echo $_lang['resource_summary']?></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_summary_help']?>" onclick="alert(this.alt);" style="cursor:help;" spellcheck="true"/></td></tr>
...
?>
                </select> &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['page_data_template_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
            <tr style="height: 24px;"><td align="left" style="width:100px;"><span class="warning"><?php echo $_lang['resource_opt_menu_title']?></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_menu_title_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
            <tr style="height: 24px;"><td align="left" style="width:100px;"><span class="warning"><?php echo $_lang['resource_opt_menu_index']?></span></td>
                <td>
                    ...
                    &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_menu_index_help']?>" onclick="alert(this.title);" style="cursor:help;"></span>
                    </td>
                </tr>
            <tr style="height: 24px;">
              <td align="left" style="width:100px;"><span class="warning"><?php echo $_lang['resource_opt_show_menu']?></span></td>
                <td><input name="hidemenucheck" type="checkbox" class="checkbox" <?php echo $content['hidemenu']!=1 ? 'checked="checked"':''?> onclick="changestate(document.mutate.hidemenu);" /><input type="hidden" name="hidemenu" class="hidden" value="<?php echo ($content['hidemenu']==1) ? 1 : 0?>" />
                    &nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_show_menu_help']?>" onclick="alert(this.title);" style="cursor:help;"></span>
                    </td>
                </tr>
            ...
            <tr style="height: 24px;"><td valign="top"><span class="warning"><?php echo $_lang['resource_parent']?></span></td>
                ...
                ?>&nbsp;<span alt="tree_folder" id="plock" class="im <?php echo $_style["tree_folder"] ?>" onclick="enableParentSelection(!allowParentSelection);" style="cursor:pointer;"></span> <b><span id="parentName"><?php echo isset($_REQUEST['pid']) ? $_REQUEST['pid'] : $content['parent']?> (<?php echo $parentname?>)</span></b>
    &nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_parent_help']?>" onclick="alert(this.title);" style="cursor:help;"></span>
    ...
    <div class="tab-page" id="tabSettings">
        ...
        <?php $mx_can_pub = $modx->hasPermission('publish_document') ? '' : 'disabled="disabled" '; ?>
            <tr style="height: 24px;">
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_published_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td>
            </tr>
            <tr style="height: 24px;">
                ...
                <span class="<?php echo $_style["icons_cal_nodate"] ?>" width="16" height="16" border="0" alt="<?php echo $_lang['remove_date']?>"></span></a>
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['page_data_publishdate_help']?>" onclick="alert(this.title);" style="cursor:help;"></span>
                </td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr style="height: 24px;">
                ...
                <span class="<?php echo $_style["icons_cal_nodate"] ?>" width="16" height="16" border="0" alt="<?php echo $_lang['remove_date']?>"></span></a>
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['page_data_unpublishdate_help']?>" onclick="alert(this.title);" style="cursor:help;"></span>
                </td>
            </tr>
            <tr>
                <td></td>
...
?>
            <tr style="height: 24px;"><td width="150"><span class="warning"><?php echo $_lang['resource_type']?></span></td>
                <td><select name="type" class="inputBox" onchange="documentDirty=true;" style="width:200px">
                    ...
                    &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_type_message']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
            ...
            ?>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['page_data_contentType_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
            <tr style="height: 24px;"><td width="150"><span class="warning"><?php echo $_lang['resource_opt_contentdispo']?></span></td>
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_contentdispo_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td></tr>
...
?>
            ...
            <tr style="height: 24px;">
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_folder_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td>
            </tr>
...
<?php echo $_lang['resource_opt_alvisibled']?>
                ...
                <td><input name="alias_visible_check" type="checkbox" class="checkbox" <?php echo (!isset($content['alias_visible'])|| $content['alias_visible']==1) ? "checked" : ''?> onclick="changestate(document.mutate.alias_visible);" /> 
                <input type="hidden" name="alias_visible" value="<?php echo (!isset($content['alias_visible']) || $content['alias_visible']==1) ? 1 : 0?>" />
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_alvisibled_help']?>" onclick="alert(this.title);" style="cursor:help;"></span>
                </td>
            </tr>
            <tr style="height: 24px;">
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_richtext_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td>
            </tr>
            <tr style="height: 24px;">
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_trackvisit_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td>
            </tr>
            <tr style="height: 24px;">
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['page_data_searchable_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td>
            </tr>
            <tr style="height: 24px;">
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['page_data_cacheable_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td>
            </tr>
            <tr style="height: 24px;">
                ...
                &nbsp;&nbsp;<span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['resource_opt_emptycache_help']?>" onclick="alert(this.title);" style="cursor:help;"></span></td>
            </tr>
        </table>
    </div><!-- end #tabSettings -->
    <?php } ?>
