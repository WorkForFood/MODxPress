...
<div id="actions">
	<ul class="actionButtons">
		<li><a href="javascript:void(0)" onclick="documentDirty=false; document.userform.save.click();"><span class="<?php echo $_style["icons_save"]?>"></span> <?php echo $_lang['save']?></a></li>
