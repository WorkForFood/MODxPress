...
<div id="actions">
	<ul class="actionButtons">
		<li><a href="index.php?a=106"><span class="<?php echo $_style["icons_cancel"]?>"></span> <?php echo $_lang['close']; ?></a>
	</ul>
</div>
...
<p><span class="<?php echo $_style["icons_modules"] ?>" alt="" align="left"></span> <?php echo $_lang['module_resource_msg']; ?></p>
<div class="actionButtons">
	<ul class="actionButtons">
		<li><a class="searchtoolbarbtn" href="#" onclick="removeDependencies();return false;"><span class="<?php echo $_style["icons_delete_document"]?>" align="absmiddle"></span> <?php echo $_lang['remove']; ?></a></li>
		<li><a class="searchtoolbarbtn" href="#" onclick="addSnippet();return false;"><span class="<?php echo $_style["icons_add"] ?>" align="absmiddle"></span> <?php echo $_lang['add_snippet']; ?></a></li>
		<li><a class="searchtoolbarbtn" href="#" onclick="addDocument();return false;"><span class="<?php echo $_style["icons_add"] ?>" align="absmiddle"></span> <?php echo $_lang['add_doc']; ?></a></li>
		<li><a class="searchtoolbarbtn" href="#" onclick="addChunk();return false;"><span class="<?php echo $_style["icons_add"] ?>" align="absmiddle"></span> <?php echo $_lang['add_chunk']; ?></a></li>
		<li><a class="searchtoolbarbtn" href="#" onclick="addPlugin();return false;"><span class="<?php echo $_style["icons_add"] ?>" align="absmiddle"></span> <?php echo $_lang['add_plugin']; ?></a></li>
		<li><a class="searchtoolbarbtn" href="#" onclick="addTV();return false;"><span class="<?php echo $_style["icons_add"] ?>" align="absmiddle"></span> <?php echo $_lang['add_tv']; ?></a></li>
		<li><a class="searchtoolbarbtn" href="#" onclick="addTemplate();return false;"><span class="<?php echo $_style["icons_add"] ?>" align="absmiddle"></span> <?php echo $_lang['add_template']; ?></a></li>
	</ul>
</div>
...
<!-- Dependencies -->
	 <table width="100%" border="0" cellspacing="1" cellpadding="2" style="display:none;">
	  <tr>
		<td valign="top" align="left">
		<!-- there was old depend table -->
		</td>
		<td valign="top" width="120" style="background-color:#eeeeee">
			<!-- there was old buttons -->
		</td>
	  </tr>
	</table>
</div>
