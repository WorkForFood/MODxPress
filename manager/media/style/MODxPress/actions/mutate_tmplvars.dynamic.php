...
<input type="hidden" name="params" value="<?php echo htmlspecialchars($content['display_params']);?>">
    ...
    <div id="actions">
    	  <ul class="actionButtons">
    		  ...
    		  <?php
    			if ($_GET['a'] == '301') { ?>
    		  <li id="Button2"><a href="#" onclick="duplicaterecord();"><span class="<?php echo $_style["icons_resource_duplicate"] ?>"></span> <?php echo $_lang["duplicate"]; ?></a></li>
    		  <li id="Button3" class="disabled"><a href="#" onclick="deletedocument();"><span class="<?php echo $_style["icons_delete_document"]?>"></span> <?php echo $_lang['delete']?></a></li>
    		  <?php } else { ?>
    		  <li id="Button3"><a href="#" onclick="deletedocument();"><span class="<?php echo $_style["icons_delete_document"]?>"></span> <?php echo $_lang['delete']?></a></li>
    		  <?php } ?>	
    		  <li id="Button5"><a href="#" onclick="documentDirty=false;document.location.href='index.php?a=76';"><span class="<?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel']?></a></li>
    	  </ul>
    </div>
...
<?php endif;?>
  ...
  <tr>
	...
	<td nowrap="nowrap"><textarea name="elements" maxlength="65535" class="inputBox textarea" onchange="documentDirty=true;"><?php echo htmlspecialchars($content['elements']);?></textarea> <span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['tmplvars_binding_msg']; ?>" onclick="alert(this.alt);" style="cursor:help"></span></td>
  </tr>
  <tr>
    <th><?php echo $_lang['tmplvars_default']; ?>:&nbsp;&nbsp;</th>
    <td nowrap="nowrap"><textarea name="default_text" type="text" class="inputBox" rows="5" style="width:300px;" onchange="documentDirty=true;"><?php echo htmlspecialchars($content['default_text']);?></textarea> <span class="<?php echo $_style["icons_tooltip"]?> tooltip" title="<?php echo $_lang['tmplvars_binding_msg']; ?>" onclick="alert(this.alt);" style="cursor:help"></span></td>
  </tr>
  <tr>
  ...
  <tr id="displayparamrow">
    <th><?php echo $_lang['tmplvars_widget_prop']; ?><div style="padding-top:8px;"><a href="javascript://" onclick="resetParameters(); return false"><span class="<?php echo $_style['icons_refresh']; ?>"></span></a></div></th>
