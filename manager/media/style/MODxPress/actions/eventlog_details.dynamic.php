...
<?php if($modx->hasPermission('delete_eventlog')) { ?>
		<li id="Button3"><a href="#" onclick="deletelog();"><span class="<?php echo $_style["icons_delete_document"] ?>"></span> <?php echo $_lang['delete']; ?></a></li>
<?php } ?>
		<li id="Button4"><a href="index.php?a=114"><span class="<?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel']; ?></a></li>
	</ul>
</div>
