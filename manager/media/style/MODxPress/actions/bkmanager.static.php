...
<div class="sectionBody" id="lyr4">
	...
	<p class="actionButtons">
		<a class="primary" href="#" onclick="backup();return false;"><span class="<?php echo $_style['ed_save'];?>" ></span> <?php echo $_lang['database_table_clickbackup']?></a>
	</p>
...
?>
	...
	<div class="actionButtons" style="margin-top:10px;">
		<a href="#" class="primary" onclick="document.mutate.save.click();"><span class=="<?php echo $_style["icons_save"]?>"></span> <?php echo $_lang["bkmgr_run_sql_submit"];?></a>
	</div>
...
<div class="tab-page" id="tabSnapshot">
	...
	<div class="actionButtons" style="margin-top:10px;margin-bottom:10px;">
		<a href="#" class="primary" onclick="document.snapshot.save.click();"><span class="<?php echo $_style["icons_add"]?>"></span> <?php echo $_lang["bkmgr_snapshot_submit"];?></a>
	<input type="submit" name="save" style="display:none;" />
	</form>
	</div>
	<style type="text/css">
