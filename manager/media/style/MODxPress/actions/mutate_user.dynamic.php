...
<h1><?php echo $_lang['user_title']; ?></h1>
    <div id="actions">
    	  <ul class="actionButtons">
    		  ...
    		  <?php
    			if ($_REQUEST['a'] == '12') { ?>
    		  <li id="Button3" class="disabled"><a href="#" onclick="deleteuser();"><span class="<?php echo $_style["icons_delete_document"]?>"></span> <?php echo $_lang['delete']?></a></li>
    		  <?php } else { ?>
    		  <li id="Button3"><a href="#" onclick="deleteuser();"><span class="<?php echo $_style["icons_delete_document"]?>"></span> <?php echo $_lang['delete']?></a></li>
    		  <?php } ?>	
    		  <li id="Button5"><a href="#" onclick="documentDirty=false;document.location.href='index.php?a=75';"><span class="<?php echo $_style["icons_cancel"]?>"></span> <?php echo $_lang['cancel']?></a></li>
    	  </ul>
    </div>
<!-- Tab Start -->
    ...
    <div class="tab-page" id="tabGeneral">
		...
		<table border="0" cellspacing="0" cellpadding="3">
		  ...
		  <tr id="showname" style="display: <?php echo ($_GET['a']=='12' && (!isset($usernamedata['oldusername'])||$usernamedata['oldusername']==$usernamedata['username'])) ? $displayStyle : 'none';?> ">
			<td colspan="3">
				<span class="<?php echo $_style["icons_user"]?>"></span>&nbsp;<b><?php echo !empty($usernamedata['oldusername']) ? $usernamedata['oldusername']:$usernamedata['username']; ?></b> - <span class="comment"><a href="#" onclick="changeName();return false;"><?php echo $_lang["change_name"]; ?></a></span>
		...
		<tr>
		  ...
		  <tr>
			...
			<td>
				...
				<a onclick="document.userform.dob.value=''; return true;" onmouseover="window.status='<?php echo $_lang['remove_date']; ?>'; return true;" onmouseout="window.status=''; return true;" style="cursor:pointer; cursor:hand"><span class="<?php echo $_style["icons_cal_nodate"]?>" border="0" alt="<?php echo $_lang['remove_date']; ?>"></span></a>
			</td>
		  </tr>
		  <tr>
		...
		<?php if($_GET['a']=='12') { ?>
		  ...
		  <tr>
			...
			<td>
				...
				<a onclick="document.userform.blockeduntil.value=''; return true;" onmouseover="window.status='<?php echo $_lang['remove_date']; ?>'; return true;" onmouseout="window.status=''; return true;" style="cursor:pointer; cursor:hand"><span class="<?php echo $_style["icons_cal_nodate"]?>" border="0" alt="<?php echo $_lang['remove_date']; ?>"></span></a>
			</td>
		  </tr>
		  <tr>
			...
			<td>
				...
				<a onclick="document.userform.blockedafter.value=''; return true;" onmouseover="window.status='<?php echo $_lang['remove_date']; ?>'; return true;" onmouseout="window.status=''; return true;" style="cursor:pointer; cursor:hand"><span class="absmiddle" src="<?php echo $_style["icons_cal_nodate"]?>" border="0" alt="<?php echo $_lang['remove_date']; ?>"></span></a>
			</td>
		  </tr>
		<?php
