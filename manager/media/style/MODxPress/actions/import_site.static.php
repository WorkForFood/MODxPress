...
<ul class="actionButtons">
    <li><a href="#" class="default" onclick="document.importFrm.submit();"><span class="<?php echo $_style["icons_save"] ?>"></span> <?php echo $_lang["import_site_start"]; ?></a></li>
</ul>
</form>
</fieldset>
...
?>
<ul class="actionButtons">
    <li><a href="#" onclick="document.location.href='index.php?a=2';"><span class="<?php echo $_style["icons_close"] ?>"></span> <?php echo $_lang["close"]; ?></a></li>
</ul>
<script type="text/javascript">
