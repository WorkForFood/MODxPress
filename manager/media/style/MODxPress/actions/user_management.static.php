...
$cm->addItem($_lang["edit"],"js:menuAction(1)",false,(!$modx->hasPermission('edit_user') ? 1:0));
$cm->addItem($_lang["delete"], "js:menuAction(2)",false,(!$modx->hasPermission('delete_user') ? 1:0));
echo $cm->render();
...
<div class="sectionBody">
	...
	<div class="searchbar">
		<table border="0" style="width:100%" class="actionButtons">
			<tr>
			<td><a href="index.php?a=11"><span class="<?php echo $_style["icons_save"] ?>"></span> <?php echo $_lang['new_user']; ?></a></td>
			<td nowrap="nowrap">
				...
				<td><a href="#"  title="<?php echo $_lang["reset"];?>" onclick="resetSearch();return false;"><span class="<?php echo $_style["icons_refresh"]?>"></span></a></td>
				<td><a href="#"  title="<?php echo $_lang["list_mode"];?>" onclick="changeListMode();return false;"><span class="<?php echo $_style["icons_table"]?>"></span></a></td>
				</tr>
				</table>
			</td>
			</tr>
	...
	$grd->colTypes          = implode('||',array(
	                          'template:<a class="gridRowIcon" href="#" onclick="return showContentMenu([+id+],event);" title="'.$_lang['click_to_context'].'"><span class="fileactions '.$_style['icons_user'] .'" ></span></a>',
