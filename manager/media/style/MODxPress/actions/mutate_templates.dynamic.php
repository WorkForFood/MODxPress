...
<input type="hidden" name="mode" value="<?php echo (int) $_REQUEST['a'];?>">
    ...
    <div id="actions">
          <ul class="actionButtons">
              ...
              <?php
              if ($_REQUEST['a'] == '16') { ?>
              <li id="Button2"><a href="#" onclick="duplicatedocument();"><span class="nomobile"><span class="buttonIcon <?php echo $_style["icons_resource_duplicate"] ?>"></span> <?php echo $_lang['duplicate']?></span><span class="buttonIcon <?php echo $_style["icons_resource_duplicate"] ?> ismobile none"></span></a></li>
              ...
              <li id="Button3"><a href="#" onclick="deletedocument();"><span class="nomobile"><span class="buttonIcon <?php echo $_style["icons_delete_document"] ?>"></span> <?php echo $_lang['delete']?></span><span class="buttonIcon <?php echo $_style["icons_delete_document"] ?> ismobile none"></span></a></li>
              <?php } ?>
              <li id="Button5"><a href="#" onclick="documentDirty=false;document.location.href='index.php?a=76';"><span class="nomobile"><span class="buttonIcon <?php echo $_style["icons_cancel"] ?>"></span> <?php echo $_lang['cancel']?></span><span class="buttonIcon ismobile none <?php echo $_style["icons_cancel"] ?>"></span></a></li>
          </ul>
    </div>
